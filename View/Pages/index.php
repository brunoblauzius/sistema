<div id="inicio" class="pi-section-w pi-section-parallax pi-section-high piSectionHigh" style="background-image: url(<?= Router::url('View/webroot/site/img/crbst_bg0.png') ?>);">
...
<div id="quem-somos" class="pi-section-w pi-section-white">
...
<div id="empresa" class="pi-section-w pi-section-dark">
...
<!-- - - - - - - - - - PARA A EMPRESA SECTION - - - - - - - - - -->
<div id="cliente" class="pi-section-w pi-section-dark">
...
<!-- - - - - - - - - - CONTACT SECTION - - - - - - - - - -->
<div id="contato" class="pi-section-w pi-section-white">
            ...
            <div class="pi-row">
                ...
                <div class="pi-col-sm-6">
                    ...
                    <p class="h6 pi-uppercase pi-weight-700  pi-padding-bottom-30">
                        <i class="icon-phone pi-text-base" style="margin-right: 5px;"></i> +55. 41 4063-9936
                    </p>

                    <p>
                        Segunda à Sexta: <strong>9:00 - 18:00</strong>
                        <br>
