    ...
    <div class="clearfix"></div>
        ...
        <table class="table table-condensed table-striped">
            <thead>
                <tr>
                    <th style="width:12%" class="text-center">Nome</th>
                    ...
                    <th style="width:8%" class="text-center">Mesas</th>
            ...
            ?>
                    <tr>
                        ...
                        <td  class="text-center"><?= $registro['mesas'] ?></td>
                        <!--td class="text-center">
                    ...
                    <tr>
                        <td colspan="10">
                            <strong>Observações:</strong> <?= (trim($registro['descricao_cliente'])) ? trim($registro['descricao_cliente']) : 'não informado';?>
                            <?php
//                                $i = 1;
