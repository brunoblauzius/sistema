...
/**
 * Description of PainelOperador
 *
 * @author BRUNO
 */
class PainelOperador extends TemplatePainel implements ImprimePainel{
    ...
    public function getPainel( VerificaEstadoPainel $estado ) {
        ...
        if( $estado->getEstado() === PainelConstantes::OPERADOR ){
    ...
    protected function renderFile(\AppController $class) {
        $class->render(array('controller' => 'Usuarios', 'view' => 'operador'), 'painel' );
    }
