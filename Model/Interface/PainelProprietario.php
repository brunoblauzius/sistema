...
/**
 * Description of PainelProprietario
 *
 * @author BRUNO
 */
class PainelProprietario extends TemplatePainel implements ImprimePainel{
    ...
    public function getPainel( VerificaEstadoPainel $estado ) {
        ...
        if( $estado->getEstado() === PainelConstantes::PROPRIETARIO ){
