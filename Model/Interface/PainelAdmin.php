...
/**
 * Description of PainelAdmin
 *
 * @author BRUNO
 */
class PainelAdmin extends TemplatePainel implements ImprimePainel{
    ...
    protected function renderFile(\AppController $class) {
        $class->render(array('controller' => 'Usuarios', 'view' => 'administrador'), 'painel' );
    }
